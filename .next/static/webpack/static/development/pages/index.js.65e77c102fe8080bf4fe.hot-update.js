...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__["default"])(OmdbMovies, [{
    ...
    value: function handleToggleClick(redirect) {
      if (redirect === true) {
        console.log("next");
      } else {
        console.log("false");
    ...
    value: function renderPagination() {
      if (this.state.movies) {
        var previous_state = this.props.page > 1 ? react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("button", {
          className: "page-item",
          onClick: this.handleToggleClick(redirect = false),
          __source: {
        ...
        return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("nav", {
          ...
          className: "page-item",
          onClick: this.handleToggleClick(redirect = true),
          __source: {
            fileName: _jsxFileName,
            lineNumber: 50
          },
...
//# sourceMappingURL=index.js.65e77c102fe8080bf4fe.hot-update.js.map